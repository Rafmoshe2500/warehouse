...
- generic [ref=e2]:
  ...
  - generic [ref=e57]:
    ...
    - generic [ref=e72]:
        ...
        - generic [ref=e74]:
          ...
          - button "העלאת שריונים" [ref=e80] [cursor=pointer]:
            - generic [ref=e81]:
              - img [ref=e82]
              - text: העלאת שריונים
          - button "ייצוא" [active] [ref=e85] [cursor=pointer]:
            - generic [ref=e86]:
              - img [ref=e87]
              - text: ייצוא
      ...
      - generic [ref=e818]:
        - generic [ref=e819]:
          - heading "התקדמות ייצוא" [level=2] [ref=e820]
          - button [ref=e821] [cursor=pointer]:
            - img [ref=e822]
        - generic [ref=e826]:
          - paragraph [ref=e829]: 0% Complete
          - button "Start Export" [ref=e830] [cursor=pointer]
      - generic [ref=e832]:
        - generic [ref=e833]:
          - heading "אפשרויות ייצוא לאקסל" [level=2] [ref=e834]
          - button [ref=e835] [cursor=pointer]:
            - img [ref=e836]
        - generic [ref=e840]:
          - paragraph [ref=e841]: כיצד תרצה לייצא את הנתונים?
          - generic [ref=e842]:
            - button "ייצא עמוד נוכחי בלבד (25 שורות)" [ref=e843] [cursor=pointer]:
              - generic [ref=e844]:
                - img [ref=e845]
                - text: ייצא עמוד נוכחי בלבד (25 שורות)
            - button "ייצא את כל התוצאות (42 שורות)" [ref=e848] [cursor=pointer]:
              - generic [ref=e849]:
                - img [ref=e850]
                - text: ייצא את כל התוצאות (42 שורות)
          - button "ביטול" [ref=e855] [cursor=pointer]:
            - generic [ref=e856]: ביטול
```