          ...
          <section id="status-workflow" className="content-section">
            ...
            <div className="status-legend">
              ...
              <div className="status-legend-item">
                ...
                <span className="status-desc">ההזמנה נקלטה במחסן. מופיעה בסינון "הסתיים" ונסגרת.</span>
              </div>
            </div>
          ...
          <section id="order-management" className="content-section">
            ...
            <div className="action-cards-grid">
              ...
              <ActionMapCard
                ...
                action='מעביר את ההזמנה לסטטוס "רכש הגיע". ההזמנה מופיעה בסינון "הסתיים" ונסגרת. הכפתור מופיע רק כשהסטטוס הוא "רכש יצא".'
